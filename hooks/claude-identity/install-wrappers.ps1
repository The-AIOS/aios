...
function spawn {
    ...
    $taskPreamble = (@(
      ...
      '',
      'It emits both _index.md, EVERY HEADING in both folders, and THE LAST 5 three-hash',
      'ENTRIES OF EVERY observed/ FILE IN FULL. Absent the hook, glob it by hand --',
      ...
      '',
      'THEN judge the read against the task. This is a RANGE, not a switch -- you hold the',
      'map now, so you know what exists. Both bounds are reachable:',
      '',
      ...
      '  MAX -> every file in BOTH folders, read whole. Not a failure state. Right when',
