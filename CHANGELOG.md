...
**Also closed:** a safety check in `/aios:update`'s reconcile that could *report* a broken run but not *stop* it. It had never fired. ([#161](https://github.com/The-AIOS/aios/pull/161))
